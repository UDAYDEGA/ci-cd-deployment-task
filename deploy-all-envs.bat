...
set CONNECTED_APP_ID=4d2ab59fe904412a8e9de0c0e6f062a5
set CONNECTED_APP_SECRET=8cD852DE9c21462784D3e2007D1d1AA5
set BUSINESS_GROUP=efeadf51-7191-4c48-805e-af0726859475

REM ─── EXCHANGE PUBLISH credentials ────────────
set ANYPOINT_USERNAME=~~~Client~~~
set ANYPOINT_PASSWORD=4d2ab59fe904412a8e9de0c0e6f062a5~?~8cD852DE9c21462784D3e2007D1d1AA5
